...
import com.example.config.ai.spring.etl.reader.DocumentReader;
...
public class DocumentReaderTest {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ByteArrayInputStream inputStream1 = new ByteArrayInputStream(JSON.toJSONString(Map.of("name", "roc",
                "age", "18")).getBytes());
        ...
        FileInputStream inputStream5 = new FileInputStream(PROJECT_PATH + "\\src\\test\\java\\com\\example" +
                "\\ai\\file\\test.pdf");
        ...
        FileInputStream inputStream6 = new FileInputStream(PROJECT_PATH + "\\src\\test\\java\\com\\example" +
                "\\ai\\file\\test.pdf");
        ...
        FileInputStream inputStream7 = new FileInputStream(PROJECT_PATH + "\\src\\test\\java\\com\\example" +
                "\\ai\\file\\test.docx");
