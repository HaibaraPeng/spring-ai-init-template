...
public interface Constants {
    ...
    Pattern REGEX_NUMBER_AND_LETTER_AND_CHINESE_CHARACTER_PATTERN =
            Pattern.compile(REGEX_NUMBER_AND_LETTER_AND_CHINESE_CHARACTER_STR);
     ...
     * 身份证的正则表达式
     */
    String REGEX_ID_CARD_STR = "^[1-9]\\d{5}((((19|[2-9][0-9])\\d{2})(0[13578]|1[02])(0[1-9]|[12][0-9]|3[01]))|((" +
            "(19|[2-9][0-9])\\d{2})(0[13456789]|1[012])(0[1-9]|[12][0-9]|30))|(((19|[2-9][0-9])\\d{2})02" +
            "(0[1-9]|1[0-9]|2[0-8]))|(((1[6-9]|[2-9][0-9])(0[48]|[2468][048]|[13579][26])|(" +
            "(16|[2468][048]|[3579][26])00))0229))\\d{3}[0-9Xx]$";
     ...
     * 车牌的正则表达式
     */
    String REGEX_LICENSE_PLATE_STR = "^[京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领][A-HJ-NP-Z][A-HJ-NP-Z0-9]{4}[A-HJ-NP-Z0-9" +
            "挂学警港澳]$";
     ...
     * IPv4地址的正则表达式
     */
    String REGEX_IPV_4_STR = "^(?!0)(?!.*\\.\\.)(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9]?[0-9])(\\." +
     ...
     * IPv6地址的正则表达式
     */
    String REGEX_IPV_6_STR = "^(([0-9a-fA-F]{1,4}:){7}([0-9a-fA-F]{1,4}|:)|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1," +
            "4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}" +
            ...
            "(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]+|::(ffff(:0{1,4})?:)?((25[0-5]|(2[0-4]|1?[0-9]|)[0-9])\\.){3}" +
