...
import com.example.common.base.HttpStatus;
import com.example.common.base.R;
import com.example.exception.customize.*;
...
public class GlobalExceptionHandler {
    ...
    public R<Void> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException e,
        ...
        return R.fail(HttpStatus.BAD_REQUEST, String.format("请求参数类型不匹配，参数[%s]要求类型为：'%s'，但输入值为：'%s'", e.getName(),
    ...
    public R<Void> handleMethodArgumentNotValidException(MethodArgumentNotValidException e,
        ...
        String message = Objects.isNull(e.getBindingResult().getFieldError()) ? "No Message" :
