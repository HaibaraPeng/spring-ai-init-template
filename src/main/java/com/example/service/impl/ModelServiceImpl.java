...
import com.example.config.ai.spring.enums.*;
import com.example.config.ai.spring.service.chat.model.ChatModelBase;
import com.example.config.ai.spring.service.image.model.enums.AzureOpenAiImageType;
import com.example.config.ai.spring.service.image.model.enums.OpenAiImageType;
import com.example.config.ai.spring.service.image.model.enums.StabilityAiImageType;
import com.example.config.ai.spring.service.image.model.enums.ZhiPuAiImageType;
import com.example.config.ai.spring.service.transcription.model.TranscriptionModelBase;
import com.example.config.ai.spring.service.transcription.model.enums.AzureOpenAiTranscriptionType;
import com.example.config.ai.spring.service.transcription.model.enums.OpenAiTranscriptionType;
import com.example.config.ai.spring.service.tts.model.enums.OpenAiTtsType;
...
public class ModelServiceImpl extends ServiceImpl<ModelMapper, Model> implements ModelService {
    ...
    private Model getModelByDto(ModelAddOrUpdateDto modelAddOrUpdateDto) {
        ...
        if ("chat".equals(type)) {
            ...
            Double realTemperature = Objects.isNull(temperature) ? TranscriptionModelBase.DEFAULT_TEMPERATURE :
                    temperature;
