...
public class AuthServiceImpl extends ServiceImpl<UserMapper, User> implements AuthService {
    ...
    public AuthLoginVo login(AuthLoginDto authLoginDto) {
            ...
            if (userInDatabase.getLoginNum() < maxLoginNum) {
                ...
                if (!Objects.equals(userInDatabase.getLoginNum(), maxLoginNum - 1)) {
                    throw new CustomizeReturnException(ReturnCode.PASSWORD_VERIFICATION_FAILED,
                            "第" + (userInDatabase.getLoginNum() + 1) + "次错误");
                } else {
        ...
        File avatarFile = Objects.equals(authLoginVo.getAvatarId(), Constants.NULL_ID) ? null :
                fileMapper.selectById(authLoginVo.getAvatarId());
