package com.example.config.mail.async;
...
public class MailAsyncMethod {
    ...
    public void sendSimpleMail(SimpleMailMessage simpleMailMessage) {
        ...
        try {
            ...
            log.info("The message was successfully sent from {} to {}", simpleMailMessage.getFrom(),
                    Arrays.toString(simpleMailMessage.getTo()));
        } catch (Exception e) {
            log.error("An error occurred in the message sent from {} to {} ==> {}", simpleMailMessage.getFrom(),
                    Arrays.toString(simpleMailMessage.getTo()), e.getCause().toString());
        }
    }
