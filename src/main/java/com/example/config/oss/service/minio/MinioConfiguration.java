package com.example.config.oss.service.minio;


import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.example.common.base.Constants;
import com.example.common.base.ReturnCode;
import com.example.config.oss.common.enums.OssType;
import com.example.config.oss.service.minio.condition.OssMinioCondition;
import com.example.config.oss.service.minio.properties.MinioProperties;
import com.example.exception.customize.CustomizeFileException;
import com.example.model.entity.File;
import com.example.service.FileService;
import com.example.utils.encrypt.SHA3Utils;
...
public class MinioConfiguration {
    ...
    public File uploadToMinio(MultipartFile file, String rootPath) {
        ...
        String originalName = StringUtils.isNotBlank(file.getOriginalFilename()) ? file.getOriginalFilename() :
                file.getName();
        ...
        return ((MinioConfiguration) AopContext.currentProxy()).uploadToMinio(inputStream, originalName, suffix,
                rootPath);
    }
    ...
    public File uploadToMinio(InputStream inputStream, String originalName, String suffix, String rootPath) {
        try (MinioClient minioClient = getMinioClient(); inputStream) {
            ...
            String fileName =
                    UUID.randomUUID().toString().replaceAll("-", "") + System.currentTimeMillis() + "." + suffix;
