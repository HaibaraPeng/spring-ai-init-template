package com.example.config.ai.spring.etl.reader;
...
public class DocumentReader {
     ...
     */
    public static List<Document> readMarkdown(InputStream inputStream, Boolean includeHorizontal,
                                              Boolean includeCodeBlock, Boolean includeBlockquote) {
        if (Objects.isNull(inputStream)) {
            throw new CustomizeAiException(ReturnCode.PARAMETER_FORMAT_MISMATCH, "参数[inputStream]不能为空");
        }
        Resource resource = new InputStreamResource(inputStream);
