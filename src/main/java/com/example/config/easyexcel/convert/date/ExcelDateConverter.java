...
public class ExcelDateConverter implements Converter<Date> {
     ...
     */
    @Override
    public Date convertToJavaData(ReadCellData readCellData, ExcelContentProperty contentProperty,
     ...
     */
    @Override
    public WriteCellData<Object> convertToExcelData(Date value, ExcelContentProperty contentProperty,
                                                    GlobalConfiguration globalConfiguration) {
