...
import com.example.config.mail.MailManager;
import lombok.extern.slf4j.Slf4j;
import org.springframework.web.multipart.MultipartFile;

/**
 * @author Peng
 * @date 2025-09-26 16:51
 */
@Slf4j
public class EmailUtils {
     ...
     */
    public static void sendWithImageHtmlByClient(String to, String subject, String html, String[] cids,
                                                 MultipartFile[] files) {
     ...
     */
    public static void sendWithImageHtmlByServer(String to, String subject, String html, String[] cids,
                                                 String[] filePaths) {
     ...
     */
    public static void sendWithAttachmentByClient(String to, String subject, String text, MultipartFile[] files,
                                                  Boolean isHtml) {
     ...
     * @param isHtml    是否使用HTML格式
     */
    public static void sendWithAttachmentByServer(String to, String subject, String text, String[] filePaths,
                                                  Boolean isHtml) {
