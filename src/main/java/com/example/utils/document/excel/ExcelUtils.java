package com.example.utils.document.excel;
...
import com.example.config.easyexcel.convert.date.ExcelDateConverter;
import com.example.config.easyexcel.convert.date.ExcelLocalDateTimeConverter;
import com.example.config.easyexcel.convert.floatNum.ExcelDoubleConverter;
import com.example.config.easyexcel.convert.floatNum.ExcelFloatConverter;
import com.example.config.easyexcel.convert.intNum.ExcelByteConverter;
import com.example.config.easyexcel.convert.intNum.ExcelIntegerConverter;
import com.example.config.easyexcel.convert.intNum.ExcelLongConverter;
import com.example.config.easyexcel.convert.intNum.ExcelShortConverter;
import com.example.exception.customize.CustomizeDocumentException;
...
//     * @return Excel -> Java 结果
//     */
//    public static <T> ExcelResult<T> importStreamWithListener(InputStream inputStream, String sheetName,
//                                                              Class<T> clazz) {
//        DefaultExcelListener<T> listener = new DefaultExcelListener<T>();
//        EasyExcel
//                .read(inputStream, clazz, listener)
...
//     */
//    public static <T> ExcelResult<T> importStreamWithListener(InputStream inputStream, String sheetName,
//                                                              Class<T> clazz, ExcelListener<T> listener) {
//        EasyExcel
//                .read(inputStream, clazz, listener)
//                .autoCloseStream(false)
//                .sheet(sheetName)
...
//     * @return Excel -> Java 结果
//     */
//    public static <T> ExcelResult<T> importStreamSyncWithListener(InputStream inputStream, String sheetName,
//                                                                  Class<T> clazz) {
//        DefaultExcelListener<T> listener = new DefaultExcelListener<T>();
//        EasyExcel
//                .read(inputStream, clazz, listener)
...
//     * @return Excel -> Java 结果
//     */
//    public static <T> ExcelResult<T> importStreamAndCloseWithListener(InputStream inputStream, String sheetName,
//                                                                      Class<T> clazz) {
//        DefaultExcelListener<T> listener = new DefaultExcelListener<T>();
//        EasyExcel
//                .read(inputStream, clazz, listener)
...
//     * @return Excel -> Java 结果
//     */
//    public static <T> ExcelResult<T> importStreamSyncAndCloseWithListener(InputStream inputStream, String sheetName,
//                                                                          Class<T> clazz) {
//        DefaultExcelListener<T> listener = new DefaultExcelListener<T>();
//        EasyExcel
//                .read(inputStream, clazz, listener)
...
//     * @return Excel -> Java 结果
//     */
//    public static <T> ExcelResult<T> importFileWithListener(File excelFile, Class<T> clazz, ExcelListener<T>
//    listener) {
//        EasyExcel
//                .read(excelFile, clazz, listener)
//                .sheet()
...
//                }
//                pathName =
//                        pathName + "/" + (StringUtils.isEmpty(sheetName) ? "defaultName" : sheetName) +
...
//     * @param <T>              泛型T
//     */
//    public static <T> void exportFileOutputStream(List<T> list, String sheetName, Class<T> clazz,
...
//     * @param <T>              泛型T
//     */
//    public static <T> void exportFileOutputStreamAndClose(List<T> list, String sheetName, Class<T> clazz,
//                                                          FileOutputStream fileOutputStream) {
...
//    }
     ...
     * @param <T>       泛型T
     */
    public static <T> void exportHttpServletResponse(List<T> list, String sheetName, Class<T> clazz,
...
//     * @param <T>          泛型T
//     */
//    public static <T> void exportTemplateOutputStream(String templateName, Class<T> clazz, OutputStream
//    outputStream) {
...
//    }
     ...
     * @param <T>          泛型T
     */
    public static <T> void exportTemplateOutputStreamAndClose(String templateName, Class<T> clazz,
     ...
     * @param <T>          泛型T
     */
    public static <T> void exportTemplateHttpServletResponse(String templateName, Class<T> clazz,
                                                             HttpServletResponse response) {
        try {
...
//                    new ClassPathResource("templates/excel/" + templateName + ExcelTypeEnum.XLSX.getValue());
//            if (!classPathResource.exists()) {
//                throw new CustomizeDocumentException(ReturnCode.EXCEL_FILE_ERROR, "模板文件[" + templateName + "
//                .xlsx]未找到");
//            }
...
//     * @param <T>          泛型T
//     */
//    public static <T> void exportOutputStream(List<T> list, String sheetName, Class<T> clazz,
//                                              OutputStream outputStream) {
//        EasyExcel
...
//    }
     ...
     * @param <T>          泛型T
     */
    public static <T> void exportOutputStreamAndClose(List<T> list, String sheetName, Class<T> clazz,
                                                      OutputStream outputStream) {
        EasyExcel
                .write(outputStream, clazz)
                .registerWriteHandler(new LongestMatchColumnWidthStyleStrategy())
     ...
     * @param response 响应
     */
    private static void handleResponse(String fileName, HttpServletResponse response) throws
